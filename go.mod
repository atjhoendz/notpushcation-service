module github.com/atjhoendz/notpushcation-service
...
require (
	...
	github.com/kumparan/ferstream v1.8.2
	github.com/kumparan/go-connect v1.7.0
	...
	gitlab.kumparan.com/yowez/comment-service v1.40.0
